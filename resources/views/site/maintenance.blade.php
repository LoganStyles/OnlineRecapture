...
<script type="text/javascript" src="{{asset('/js/maintenance/jquery-1.11.1.min.js')}}"></script>
<link rel="stylesheet" href="{{asset('/css/maintenance/bootstrap.min.css')}}" type="text/css" media="all" />
<script type="text/javascript" src="{{asset('/js/maintenance/bootstrap.min.js')}}"></script>
        ...
        <div class="col-md-6">
            <div class="error-template">
                ...
                <div class="error-actions">
                    <a href="https://ieianchorpensions.com/" style="margin-top: 10px;" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">
                    </span>Back to Main Site </a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
